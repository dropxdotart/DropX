      ...
      <div className="w-full max-w-sm space-y-4">
        ...
        <Card className="border-white/10 bg-card/60 backdrop-blur-sm">
          <CardContent className="flex items-center justify-around py-1">
            <FollowListDialog userId={user.id} kind="followers" count={followerCount ?? 0} label="Followers" />
            <div className="w-px h-8 bg-white/10" />
            <FollowListDialog userId={user.id} kind="following" count={followingCount ?? 0} label="Following" />
          </CardContent>
        </Card>
